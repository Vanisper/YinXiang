...
class d extends l {
  ...
  setDragResistance() {
    ...
    if (
      (t &&
        ((i = this.dragPosition.x < t.from), (s = this.dragPosition.x > t.to)),
      e &&
        ((o = this.dragPosition.y < e.from), (n = this.dragPosition.y > e.to)),
      (i || s) && (!i || !s))
    ) {
...
const p = {
  ...
  Dots: class {
    ...
    buildList() {
      if (
        this.carousel.pages.length < this.carousel.option('Dots.minSlideCount')
      )
        return
...
class y extends l {
  ...
  getSlideMetrics(t) {
    ...
    return (
      (e =
        e + (parseFloat(s.marginLeft) || 0) + (parseFloat(s.marginRight) || 0)),
    ...
    this.slides.forEach((e, i) => {
      ...
      e.$el
        ? (i !== r || e.hasDiff ? (s = h + e.hasDiff * t) : (h = 0),
          (e.$el.style.left =
            Math.abs(s) > 0.1 ? `${h + e.hasDiff * t}px` : ''),
          r++)
        : (h += e.width)
    }),
...
class L {
  ...
  static create(t) {
    function e() {
      window.addEventListener('hashchange', L.onHashChange, !1),
        L.startFromUrl()
    }
    ;(L.Fancybox = t),
      v &&
...
class F extends l {
  ...
  static fromOpener(t, i = {}) {
    let s = [],
      ...
      n = i.target || null
    const a =
        void 0 !== (i = e({}, i, F.openers.get(t))).groupAll && i.groupAll,
...
export { y as Carousel, F as Fancybox, d as Panzoom }
